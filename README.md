...
<ul>
  ...
  <li>Multiple hr(horizontal rule) tags have been used to seperate the site into multiple sections along with a wide use of ul(unordered list) tags to create unordered lists with bullet points.</li>
